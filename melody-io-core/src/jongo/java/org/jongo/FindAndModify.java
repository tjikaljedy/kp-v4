...
public class FindAndModify {
	...
	FindAndModify(DBCollection collection, Unmarshaller unmarshaller, QueryFactory queryFactory, String query,
			Object... parameters) {
	...
	public <T> T map(ResultHandler<T> resultHandler) {
		DBObject result = collection.findAndModify(query.toDBObject(), getAsDBObject(fields), getAsDBObject(sort),
				remove, getAsDBObject(modifier), returnNew, upsert);
