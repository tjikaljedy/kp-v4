...
class MongoBsonParser extends BsonParser {
	...
	private byte[] createFromLegacyFormat(int time, int machine, int inc) {
		// Reimplementing createFromLegacyFormat because bson4jackson library is not
		// compatible with the new ObjectId spec
		// see issue https://github.com/michel-kraemer/bson4jackson/issues/94
		// Former implementation
		// https://github.com/mongodb/mongo-java-driver/blob/3.12.x/bson/src/main/org/bson/types/ObjectId.java#L248
